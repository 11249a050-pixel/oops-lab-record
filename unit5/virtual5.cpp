...
double basic, bonus;
public:
FullTime(const string& n, double b, double bo) : Employee(n), basic(b),
bonus(bo) {}
...
int hours;
public:
PartTime(const string& n, double r, int h) : Employee(n), hourlyRate(r),
hours(h) {}
double calculateSalary() override {
...
// late binding: calls derived implementations
e1->show();
e2->show();
delete e1; delete e2;
return 0;
